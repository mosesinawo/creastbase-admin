            ...
            <div className=''>
                <div className='d-flex gap-3 '>
                    <div className='--relative apt-imageContainer1 '>
                        <img src={land1} alt="apt1" className='apt-img-1  ' />
                    ...
                    <div className='d-flex flex-column gap-3 apt-imageContainer2'>
                        <div className='--relative'>
                            <img src={land2} alt="apt2" className='apt-img-2' />
                            <p className='apt-imgTag'>Sitting Room</p>
                        </div>
                        <div className='--relative'>
                            <img src={land3} alt="apt3" className='apt-img-2' />
                ...
                <div className='d-flex justify-content-between mt-4'>
                    <div className='d-flex gap-4'>
                        <p style={{ color: '#262C55', fontSize: 20, fontWeight: '700' }}>Eleko Frontal Beach <span className='apt-size-tag'> <MoreCircle size="5" color="#011B3366" variant="Bold" /> &nbsp; 500sqm</span></p>
